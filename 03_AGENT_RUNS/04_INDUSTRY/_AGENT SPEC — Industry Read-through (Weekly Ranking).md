...
- **VERIFIED FACT** — Official company guidance, SEC filing, earnings call, analyst action (rating/price-target change), or major financial media report with date and source cited
- **CAOS INFERENCE** — Structural conclusion drawn from verified facts and market context but not directly stated by a source (e.g., "guidance implies 2026 capex acceleration; analyst reports on optical interconnect adoption confirm demand driver")
- **UNVERIFIED LEAD** — Promising structural indicator requiring further research; credibility unknown (e.g., "industry rumor that major hyperscaler is reducing data-center capex"; requires confirmation before conviction shift)
- **DATA LIMITED** — Relevant structural evidence may exist but source unavailable, incomplete, or market access restricted (e.g., "analyst report on optical-interconnect penetration not yet published"; resume with available data)
- **UNKNOWN** — Structural condition or competitive shift status unknown; evidence insufficient to assess sector-level change
